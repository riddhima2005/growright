...
const featuredPlants = [
  { id: 1, name: "Tomato", category: "vegetables", difficulty: "beginner", season: "spring" },
  { id: 2, name: "Rose", category: "flowers", difficulty: "intermediate", season: "all" },
  { id: 3, name: "Basil", category: "herbs", difficulty: "beginner", season: "summer" },
  { id: 4, name: "Snake Plant", category: "indoor", difficulty: "beginner", season: "all" },
  { id: 5, name: "Lavender", category: "outdoor", difficulty: "intermediate", season: "spring" },
  { id: 6, name: "Mint", category: "herbs", difficulty: "beginner", season: "all" },
];
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-2">
              ...
              <h1 className="text-2xl font-bold text-nature-primary">PlantCare Pro</h1>
            </div>
